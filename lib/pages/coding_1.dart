              ...
              children: [
                ...
                Container(
                  ...
                  child: Container(
                    ...
                    child: Container(
                      padding: EdgeInsets.fromLTRB(3.5, 16, 4, 26),
                      child: Stack(
                          ...
                          SizedBox(
                            ...
                            child: Column(
                              ...
                              children: [
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            margin: EdgeInsets.fromLTRB(0, 2, 2.1, 0),
                                            child: Text(
                                              'Run',
                                              style: GoogleFonts.getFont(
                                                'Inter',
                                          ...
                                          Container(
                                            margin: EdgeInsets.fromLTRB(0, 7, 21.9, 4.9),
                                            width: 12,
                                            height: 13,
                                            child: SizedBox(
                                              width: 10.1,
                                ...
                                Container(
                                  margin: EdgeInsets.fromLTRB(2.5, 0, 0, 186),
                                  child: Container(
                                    decoration: BoxDecoration(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                ',
                                                      ...
                                                      TextSpan(
                                                        text: '"The sum of {num1} and {num2} is {sum_resul',
                                                        style: GoogleFonts.getFont(
                                                          'Inter',
                                                          fontWeight: FontWeight.w400,
                                                          fontSize: 12,
                                ...
                                Container(
                                  margin: EdgeInsets.fromLTRB(30.5, 0, 30.5, 0),
                                  child: Align(
                                    alignment: Alignment.topLeft,
                                    child: Text(
                                      'Pehla sankhya dalo: 10.5
                                Dusra sankhya dalo: 4.5
                                Dono sankhya ka yog hai: 15.0
                                ',
                                      style: GoogleFonts.getFont(
                                        'Inter',
                                        fontWeight: FontWeight.w400,
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              child: SizedBox(
                                ...
                                height: 110,
                                child: Container(
                                  padding: EdgeInsets.fromLTRB(12.3, 0, 13.7, 5),
                                  child: Stack(
                                    clipBehavior: Clip.none,
                                    children: [
                                      SizedBox(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child: Container(
                                                margin: EdgeInsets.fromLTRB(0, 0, 22.5, 8),
                                                child: Column(
                                                  mainAxisAlignment: MainAxisAlignment.start,
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
                                            ...
                                            The sum of 10.45 and 4.5 is: 15.0',
                                                style: GoogleFonts.getFont(
                                                  'Inter',
                                                  fontWeight: FontWeight.w400,
                                                  fontSize: 12,
                        ...
                        child: Row(
                          ...
                          children: [
                            SizedBox(
                              ...
                              height: 33,
                              child: SvgPicture.asset(
                                'assets/vectors/ionhome_2_x2.svg',
                              ),
                            ),
                            Container(
