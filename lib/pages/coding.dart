          ...
          SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  margin: EdgeInsets.fromLTRB(15.8, 0, 33, 11),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                ...
                Container(
                  margin: EdgeInsets.fromLTRB(12, 0, 8, 78),
                  child: Container(
                    decoration: BoxDecoration(
                    ...
                    child: SizedBox(
                      height: 873,
                      child: Container(
                        padding: EdgeInsets.fromLTRB(3, 13, 6, 0),
                        child: Stack(
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    margin: EdgeInsets.fromLTRB(0.5, 0, 36.6, 100),
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                            ...
                            Positioned(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  color: Color(0xC7D9D9D9),
                                  borderRadius: BorderRadius.circular(3),
                                ),
                                child: Container(
                                  width: 70,
                                  height: 88,
                                  padding: EdgeInsets.fromLTRB(7, 6, 9, 4),
                                  child: SizedBox(
                                    width: 54,
                                    height: 78,
                                    child: SvgPicture.asset(
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: SizedBox(
                ...
                height: 110,
                child: Container(
                  padding: EdgeInsets.fromLTRB(14.3, 0, 0, 5),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
